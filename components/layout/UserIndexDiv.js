...
export default function UserIndexDiv({ user }) {
  return (
    ...
    >
      ...
      <div className="bg-white/60 max-w-[90vw] backdrop-blur-lg p-5 sm:p-10 rounded-xl shadow-xl">
        <h1 className="text-4xl mb-7 font-semibold text-color-800 truncate">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <IndexButton
            ...
            href="/products"
          />
          {/* // pytam czy jest uzytkownik a co jesli niema, to jest dla nie zalogowanego*/}
          {user ? (
            <>
              <IndexButton
                icon={
